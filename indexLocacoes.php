    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="card-deck">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Quadras de Tênis</h5>
                        <p class="card-text">Clique <a href="indexLocacoesTenis.php">aqui</a> para obter as datas locadas.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Responsável - Alexandro</small>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Piscina</h5>
                        <p class="card-text">Clique <a href="indexLocacaoPisicina.php">aqui</a> para obter as datas locadas.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Responsável - Alexandro</small>
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Pavilhão</h5>
                        <p class="card-text">Clique <a href="indexLocacaoPavilhao.php">aqui</a> para obter as datas locadas.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Responsável - Alexandro</small>
                ...
                <div class="card">
                    ...
                    <h5 class="card-title">Futebol</h5>
                        <p class="card-text">Clique <a href="indexLocacaoFutebol.php">aqui</a> para obter as datas locadas.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Responsável - Alexandro</small>
