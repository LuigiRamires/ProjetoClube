...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <h2 class="mb-4">Campo de Futebol</h2>
            <?php
                    ...
                    switch ($acao) {
                        case 'montar':
                            ...
                            $resultado = mysqli_query($con, $sql) or die ("Erro ao retornar o valor do banco de dados.");
                            echo "<form method='post' name='dados' action='indexLocacaoFutebol.php?acao=atualizar' onSubmit='return enviardados();'>";
                            ...
                            while($registro = mysqli_fetch_array($resultado)){
                                ...
                                echo "<button type='submit' formaction='indexLocacaoFutebol.php?acao=selecionar'>Selecionar</button>";
                                echo"</td>";
                                echo "</tr></th>";
                                echo"</form>";
                            }
                        ...
                        case 'atualizar':
                            ...
                            mysqli_close($con);
                            header("Location:indexLocacaoFutebol.php?acao=selecionar");
                        break;
                        ...
                        case 'inserir':
                            ...
                            $sql = "INSERT INTO tb_aluguel (cod_instalacao, dt_aluguel) VALUES (6,'$dtaluguel')";
                        ...
                        case 'selecionar':
                            ...
                            echo "<center><a href='indexInsertFutebol.php'><img src='img/insert_crud.png' alt='Inserir' title='Inserir Registro' registro'></center><br/>";
                            ...
                            while ($registro = mysqli_fetch_array($resultado)){
                                ...
                                echo "<td>".$codsocio."</td>";
                                echo "<td><a href='indexLocacaoFutebol.php?acao=deletar&id=$codaluguel'><img src='img/delete_crud.png' alt='Deletar' title='Deletar' registro'>
                                <a href='indexLocacaoFutebol.php?acao=montar&id=$codaluguel'><img src='img/update_crud.png' alt='Atualizar' title='Atualizar' registro'>
                                <a href='indexInsertFutebol.php'><img src='img/insert_crud.png' alt='Inserir' title='Inserir Registro' registro'></td>";
                            }
