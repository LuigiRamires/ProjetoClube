            ...
            <?php
                    ...
                    switch ($acao) {
                        case 'montar':
                            ...
                            $resultado = mysqli_query($con, $sql) or die ("Erro ao retornar o valor do banco de dados.");
                            echo "<form method='post' name='dados' action='indexAula1.php?acao=atualizar' onSubmit='return enviardados();'>";
                            ...
                            while($registro = mysqli_fetch_array($resultado)){
                                ...
                                echo "<button type='submit' formaction='indexAula1.php?acao=selecionar'>Selecionar</button>";
                                echo"</td>";
                                echo "</tr></th>";
                                echo"</form>";
                            }
                        ...
                        case 'atualizar':
                            ...
                            mysqli_close($con);
                            header("Location:indexAula1.php?acao=selecionar");
                        break;
                        ...
                        case 'selecionar':
                            ...
                            echo "<center><a href='indexAulas1Cadastrar.php'><img src='img/insert_crud.png' alt='Inserir' title='Inserir Registro' registro'></center><br/>";
                            ...
                            while ($registro = mysqli_fetch_array($resultado)){
                                ...
                                echo "<td>".$codsocio."</td>";
                                echo "<td><a href='indexAula1.php?acao=deletar&id=$cod'><img src='img/delete_crud.png' alt='Deletar' title='Deletar' registro'>
                                <a href='indexAula1.php?acao=montar&id=$cod'><img src='img/update_crud.png' alt='Atualizar' title='Atualizar' registro'>
                                <a href='indexAulas1Cadastrar.php'><img src='img/insert_crud.png' alt='Inserir' title='Inserir Registro' registro'></td>";
                            }
