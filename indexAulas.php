    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="card-deck">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tênis - 13h00</h5>
                        <p class="card-text">Clique <a href="indexAula1.php?acao=selecionar">aqui</a> para obter a lista de alunos.
                        </p>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Ginástica - 15h00</h5>
                        <p class="card-text">Clique <a href="indexAula2.php?acao=selecionar">aqui</a> para obter a lista de alunos.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Professor - Alexandro</small>
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Natação - 15h00</h5>
                        <p class="card-text">Clique <a href="indexAula3.php?acao=selecionar">aqui</a> para obter a lista de alunos.
                        </p>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Professor - Alexandro</small>
